window.onload = () => {
    const imgElement = document.getElementById('div_product-image') as HTMLImageElement;
    ...
    function handleImageLoad() {
        const backgroundDiv = document.getElementById('blurred-background') as HTMLElement;
        if (backgroundDiv) {
